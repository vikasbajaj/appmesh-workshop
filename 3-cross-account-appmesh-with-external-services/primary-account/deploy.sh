...
deploy_app() {
    ...
    aws cloudformation deploy \
        ...
        --capabilities CAPABILITY_IAM \
        --parameter-overrides "ProjectName=${PROJECT_NAME}" "EnvoyImage=${ENVOY_IMAGE}" "EnquiryImage=${ENQUIRY_IMAGE}" "DBName=${DB_NAME}" "DBUser=${DB_USER}" "DBPassword=${DB_PWD}"
}
